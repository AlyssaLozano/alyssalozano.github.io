  ...
  return (
    <section className="relative min-h-[60vh] flex items-center overflow-hidden bg-navy-900 grid-overlay pt-28 pb-16">
      ...
      <div
        ...
        style={{ backgroundImage: "url('https://readdy.ai/api/search-image?query=abstract%20cybersecurity%20digital%20shield%20certification%20badge%20dark%20navy%20background%20gold%20geometric%20patterns%20circuit%20board%20lines%20elegant%20minimalist%20professional%20technology%20security%20credentials%20verification%20glow%20deep%20dark%20atmosphere&width=1920&height=800&seq=secplus-hero-v1&orientation=landscape')" }}
      />
