  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-navy-900 grid-overlay">
      ...
      <div
        ...
        style={{ backgroundImage: "url('https://readdy.ai/api/search-image?query=dark%20cybersecurity%20operations%20center%20control%20room%20with%20glowing%20monitors%20screens%20showing%20network%20threat%20data%20visualizations%20deep%20navy%20blue%20black%20background%20atmospheric%20moody%20cinematic%20no%20people%20abstract%20digital%20security%20aesthetic%20professional%20high%20tech%20environment%20dramatic%20lighting%20futuristic&width=1920&height=1080&seq=acumen-hero-bg-v1&orientation=landscape')" }}
      />
