  ...
  return (
    <section className="relative min-h-[52vh] flex items-end overflow-hidden bg-navy-900 grid-overlay pt-28 pb-16">
      ...
      <div
        ...
        style={{ backgroundImage: "url('https://readdy.ai/api/search-image?query=corporate%20business%20partnership%20handshake%20deal%20enterprise%20hiring%20professional%20dark%20navy%20background%20gold%20accent%20premium%20elegant%20corporate%20office%20cybersecurity%20workforce%20talent%20acquisition%20abstract%20modern&width=1920&height=800&seq=employers-hero-v1&orientation=landscape')" }}
      />
