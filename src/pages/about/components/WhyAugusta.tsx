      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          <div className="reveal-element" style={{ animationDelay: '0.15s' }}>
            <div className="rounded-2xl overflow-hidden border border-gold/15 relative" style={{ height: '380px' }}>
              <img
                src="https://readdy.ai/api/search-image?query=Augusta%20Georgia%20cityscape%20skyline%20Savannah%20River%20aerial%20view%20at%20dusk%20dramatic%20lighting%20golden%20hour%20warm%20tones%20government%20buildings%20professional%20city%20environment%20southeastern%20United%20States%20urban%20landscape%20beautiful%20atmospheric%20cinematic%20wide%20shot&width=800&height=500&seq=augusta-cityscape-v1&orientation=landscape"
        ...
        <div className="relative glass-card gold-border-glow rounded-2xl overflow-hidden mb-20 reveal-element">
          <div className="absolute inset-0 pointer-events-none">
            <img
              src="https://readdy.ai/api/search-image?query=military%20base%20operations%20center%20command%20facility%20aerial%20view%20dark%20cinematic%20deep%20navy%20atmosphere%20security%20installation%20fort%20eisenhower%20augusta%20georgia%20defense%20operations%20professional%20dramatic%20wide%20panoramic%20no%20people%20abstract&width=1400&height=400&seq=fort-eisenhower-bg-v1&orientation=landscape"
