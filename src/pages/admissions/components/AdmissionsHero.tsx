  ...
  return (
    <section className="relative min-h-[52vh] flex items-end overflow-hidden bg-navy-900 grid-overlay pt-28 pb-16">
      ...
      <div
        ...
        style={{ backgroundImage: "url('https://readdy.ai/api/search-image?query=professional%20dark%20office%20environment%20with%20sleek%20modern%20desks%20digital%20screens%20enrollment%20admissions%20application%20process%20cybersecurity%20academy%20deep%20navy%20dark%20background%20gold%20accent%20lighting%20premium%20academic%20atmosphere%20no%20people&width=1920&height=800&seq=admissions-hero-v1&orientation=landscape')" }}
      />
